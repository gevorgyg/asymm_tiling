...
> * **L1 Cache:**
>   * *Sweep 1 (Theory Validation Table)*: 8 KB capacity, 32B line size, 8-way associativity, 4-cycle access, LRU, Write-Back.
>   * *Sweep 2 (L2 Size Shift Sweep)*: 32 KB capacity, 64B line size, 8-way associativity, 4-cycle access, LRU, Write-Back.
> * **L2 Cache:**
>   * *Sweep 1 (Theory Validation Table)*: 32 KB capacity, 64B line size, 8-way associativity, 14-cycle access, LRU, Write-Back.
>   * *Sweep 2 (L2 Size Shift Sweep)*: Swept capacity $\{32, 64, 128, 256, 512\}$ KB, 64B line size, 8-way associativity, 14-cycle access, LRU, Write-Back.
