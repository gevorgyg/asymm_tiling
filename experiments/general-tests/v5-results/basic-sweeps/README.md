...
> * **Operand Precision:** Double precision ($A, B, C = 8$ bytes) [except Experiment 5 Asymmetric Precision where $B = 2$ bytes]
> * **L1 Cache:** 8 KB capacity, 8B line size, 4-way associativity, 4-cycle access, LRU replacement, Write-Back policy.
> * **L2 Cache:** 32 KB capacity, 8B line size, 8-way associativity, 15-cycle access, LRU replacement, Write-Back policy.
