...
# cheap matrix = B). Verified against the paper reads formula.
FLAGS = Flags(b_source="mem", stationary="B", three_d_reg=True, no_l2=True)
...
FLAGS_NR  = Flags(b_source="mem", stationary="B", three_d_reg=True,
