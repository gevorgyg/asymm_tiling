...
CONFIG_PATH = os.path.join(WORKSPACE_DIR, "tests", "configs", "sweep_l1_size_temp.conf")
DATA_DIR = SCRIPT_DIR
...
def main():
    print("=== Running L1 Cache Capacity Empirical Tiling Sweeps (16B Lines) ===")
...
def generate_report(all_results):
    ...
    with open(REPORT_PATH, "w") as f:
        ...
        f.write("## 1. Summary of Optimal Tile Shapes by L1 Cache Capacity\n\n")
        f.write("| L1 Capacity | Precision Config | Optimal Tile Shape ($T_M \\times T_N \\times T_K$) | Ratio ($T_N/T_M$) | Footprint (KB) | L1 Hit Rate | L2 Hit Rate | DRAM Traffic (KB) | Total Cycles |\n")
        f.write("| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |\n")
        
        for label in ["4KB", "8KB", "16KB", "32KB", "64KB"]:
        ...
        for label in ["4KB", "8KB", "16KB", "32KB", "64KB"]:
            f.write(f"## 2. Details for L1 Capacity = {label}\n\n")
        ...
        f.write("## 3. Aspect Ratio Sensitivity vs. L1 Capacity\n")
        f.write("The plot below details how the L1 capacity size affects both execution cycles and the shape aspect ratio trend.\n\n")
        f.write("![L1 Capacity Aspect Ratio Sweeps](l1_size_empirical.png)\n")
...
def generate_plots(all_results):
    ...
    try:
        ...
        for i, label in enumerate(labels):
            ...
            ax.set_title(f"L1 Capacity = {label}", fontsize=11, fontweight='bold')
        ...
        # Copy to artifact
        subprocess.run(["cp", plot_path, os.path.join(ARTIFACT_DIR, "l1_size_empirical.png")], check=True)
