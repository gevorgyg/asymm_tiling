"""Tile-shape sweep across 3 precisions, 96x96x96 matrix, C-stationary.

Self-contained: matrix dims, cache geometry, register tile, and precision
configs are all declared here. Copy this file as a starting point for a new
experiment with different hardware or sweep axes.
"""
...
def run() -> None:
    ...
    write_report(
        ...
        title="Tile Shape Sweep (96^3, 16KB L1, 64KB L2)",
        blocks=blocks,
    )
