"""Tile-shape sweep, 96^3, C-stationary: metric vs C-tile aspect ratio.

Self-contained: copy as a starting point for a new empirical experiment.
Emits the standard five metric views (cycles + per-level traffic); traffic
comes from --mulac_norecord runs, cycles from mulacc-recorded runs.
"""
...
TITLE = "Tile-shape sweep (96³, C-stationary)"
BASE_NAME = "tile_sweep"
